...
![WebFetch returns only JavaScript code with no flight data](assets/ai-browser-automation/webfetch-empty-javascript.png)
...
![API attempts all fail with authentication errors](assets/ai-browser-automation/vanilla-claude-api-failures.png)
